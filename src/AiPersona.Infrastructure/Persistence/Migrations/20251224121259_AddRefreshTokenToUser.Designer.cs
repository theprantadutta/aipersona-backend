...
namespace AiPersona.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251224121259_AddRefreshTokenToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.ContentReport", b =>
                {
                    ...
                    b.HasIndex("ResolvedById")
                        .HasDatabaseName("i_x_content_reports_resolved_by_id");
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.PersonaGreeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PersonaId")
                        .HasDatabaseName("i_x_persona_greetings_persona_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("i_x_persona_greetings_user_id");

                    b.HasIndex("UserId", "PersonaId")
                        .IsUnique()
                        .HasDatabaseName("i_x_persona_greetings_user_id_persona_id");

                    b.ToTable("persona_greetings");
                });
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.SupportTicket", b =>
                {
                    ...
                    b.HasIndex("AssignedToId")
                        .HasDatabaseName("i_x_support_tickets_assigned_to_id");
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.ContentReport", b =>
                {
                    ...
                    b.HasOne("AiPersona.Domain.Entities.User", "ResolvedBy")
                        .WithMany()
                        .HasForeignKey("ResolvedById")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("f_k_content_reports__users_resolved_by_id");
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.PersonaGreeting", b =>
                {
                    b.HasOne("AiPersona.Domain.Entities.Persona", "Persona")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_persona_greetings_personas_persona_id");
                    ...
                    b.HasOne("AiPersona.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_persona_greetings__users_user_id");
            ...
            modelBuilder.Entity("AiPersona.Domain.Entities.SupportTicket", b =>
                {
                    b.HasOne("AiPersona.Domain.Entities.User", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("f_k_support_tickets__users_assigned_to_id");
